...
public class TransferControllerTest {
	...
	public static List<CreateTransferRequest> data() {
		...
		var request10 = new CreateTransferRequest();
		...
		var request11 = new CreateTransferRequest();
		...
		var request12 = new CreateTransferRequest();
		...
		var request13 = new CreateTransferRequest();
		...
		var request14 = new CreateTransferRequest();
	...
	public void createTransaction() throws Exception {
		...
		var mockedUserByUsername = new User("Mert", "mert123", "22512567125");
		...
		var mockedTransfer = new Transfer(mockedUserByUsername.getId(), mockedUserByTcno.getId(), request.getCurrency(), request.getAmount());
		...
		var requestAsJson = new ObjectMapper().writeValueAsString(request);
