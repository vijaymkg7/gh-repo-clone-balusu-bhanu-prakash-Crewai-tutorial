...
public class TransactionServiceTest {
	...
	public void createNewTransaction() {
		var mockedTransaction = new Transaction(25681L, true, "TRY", BigDecimal.valueOf(61268));
	...
	public void findAllByUserId() {
		...
		var mockedTransaction = new Transaction(61682L, true, "EUR", BigDecimal.valueOf(12661));
