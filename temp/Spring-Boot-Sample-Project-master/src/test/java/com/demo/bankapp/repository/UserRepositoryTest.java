...
public class UserRepositoryTest {
	...
	public void test() {
		...
		// findAll
		var firstUser = new User("Mert15", "mert123", "12453561256");
		entityManager.persist(firstUser);
		entityManager.flush();

		var secondUser = new User("Mert12", "mert125", "12455561256");
		...
		// save
		var userToSave = new User("Saved_Mert", "mert1235", "12453571256");
